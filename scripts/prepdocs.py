...
from openAIRoundRobin.tableFormCovert import  table_html_to_text_by_gpt4
...
parser.add_argument("--files", help="Files to be processed",default='/Users/huqianghui/Downloads/pdf-table-sample/pdf-form-table-demo-test-script/test-pdf-files/H2_AN202208221577459815_1-12-7-8.pdf')
...
parser.add_argument("--container", help="Azure Blob Storage container name",default="content")
...
parser.add_argument("--index", help="Name of the Azure Cognitive Search index where content should be indexed (will be created if it doesn't exist)",default="pdftestindex03")
...
print("****AzureDeveloperCliCredential:{args.tenantid}")
...
print("****searchkey:{args.searchkey}")
print("****storagekey:{args.storagekey}")
default_creds = azd_credential if args.searchkey == None or args.storagekey == None else None
print("****default_creds:{default_creds}")
search_creds = default_creds if args.searchkey == None else AzureKeyCredential(args.searchkey)
print("****search_creds:{search_creds}")
        ...
        for page_num, page in enumerate(form_recognizer_results.pages):
            ...
            for idx, table_id in enumerate(table_chars):
                if table_id == -1:
                    ...
                    page_text += table_html_to_text_by_gpt4(table_to_html(tables_on_page[table_id]))
